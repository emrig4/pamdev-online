...
return [
     ...
     */
    'linkProviders' => [
        App\Helpers\ResourceLinkProvider::class,
        App\Helpers\ResourceFieldLinkProvider::class,
        App\Helpers\ResourceReadLinkProvider::class,
        App\Helpers\BlogLinkProvider::class,
    ],
    /**
