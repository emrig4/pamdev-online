    ...
    //***************************
	  jQuery(window).scroll(function() {
	      if (jQuery(this).scrollTop() > 150){  
	          jQuery('.ereaders-main-header').addClass("stickyheader");
	      }
	      else{
	          jQuery('.ereaders-main-header').removeClass("stickyheader");
	      }
	  });
...
$(function() {
  ...
  $menuTriggerd.on("click", function(e) {
    e.preventDefault();
    var $this = $(this).next();
    $this.toggleClass('active').next('ul').toggleClass('active');
  });
