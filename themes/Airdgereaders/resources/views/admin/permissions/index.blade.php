  ...
  @section('content')
        ...
        <table class="table  yajra-dt  table_bordered mt-3 w-full">
            <thead>
                <tr class="text-sm">
                    ...
                    <th class="w-40 text-left uppercase">Action</th>
                </tr>
            </thead>
            <tbody>
    ...
    <div class="modal" id="exampleModalCenteredCreateUser" data-animations="bounceInDown, bounceOutUp" data-static-backdrop>
        <div class="modal-dialog modal-dialog_centered max-w-2xl">
            ...
            <form method="POST" action="{{ route('admin.permissions.store') }}" class="modal-content" style="min-width: 600px;">
                @csrf
                ...
                <div class="modal-body">
                    ...
                    <button type="submit" class="btn btn_primary h-8 mt-10">Save permission</button>
                </div>
            </form>
