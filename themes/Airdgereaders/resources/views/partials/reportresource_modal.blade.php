<div class="fixed z-10 inset-0 overflow-y-auto" aria-labelledby="modal-title" role="dialog" aria-modal="true">
    <div class="flex items-end justify-center pt-4 px-4 pb-20 text-center sm:block sm:p-0">
        ...
        <div  class="relative inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
            <form action="{{ route('reports.store', $resource->id) }}" method="post">
                @csrf
                    ...
                    <div class="">
                        <div class="flex justify-between items-center space-x-5">
                            <div class="flex items-center space-x-5">
                                ...
                                <h3 class="text-lg leading-6 font-medium text-gray-900" id="modal-title">Report Resource </h3>
                            </div>
                        ...
                        <div class="mt-8 text-center sm:ml-4 sm:text-left">
                            ...
                            <div class=" w-full mt-4">
                                <div class=" w-full">
                                    <textarea placeholder="Comment" required  rows="5" id="ranc_amount" class="w-full" name="comment" style="min-height: 40px;"></textarea>
                                </div>
                            </div>

                            <div class=" w-full mt-4">
                                <div class=" w-full">
                                    <input type="text" rows="5" id="name" required value="{{ auth()->user()->name }}" class="w-full" name="name" style="min-height: 40px;">
                                </div>
                            </div>
                ...
                <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                    <button type="submit"  class="w-full inline-flex justify-center rounded-md border border-transparent shadow-sm px-4 py-2 bg-gray-600 text-base font-medium text-white hover:bg-gray-400  sm:ml-3 sm:w-auto sm:text-sm">Send</button>
                </div>
            </form>
        </div>
    </div>
