<div class="fixed z-10 inset-0 overflow-y-auto" aria-labelledby="modal-title" role="dialog" aria-modal="true">
    <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
        ...
        <form action="{{ route('settings.locale') }}" method="post" class="relative inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
          @csrf
                ...
                <div class="">
                    <div class="flex justify-between items-center space-x-5">
                        <div class="flex items-center space-x-5">
                            ...
                            <h3 class="text-lg leading-6 font-medium text-gray-900" id="modal-title">Preferences</h3>
                        </div>
            ...
            <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                <button type="submit" class="w-full inline-flex justify-center rounded-md border border-transparent shadow-sm px-4 py-2 bg-gray-600 text-base font-medium text-white hover:bg-gray-400  sm:ml-3 sm:w-auto sm:text-sm">Save</button>
            </div>
        </form>
    </div>
</div>
