    ...
    <div class="flex items-end justify-center pt-4 px-4 pb-20 text-center sm:block sm:p-0">
        ...
        <div  class="relative inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
                ...
                <div class="">
                    ...
                    <div class="mt-8 text-center sm:ml-4 sm:text-left">
                        ...
                        <div class="flex space-x-2 w-full mt-4">
                            ...
                            <p>Download this resource from your subscription credit unit or top-up to unlock, access and download.</p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                ...
                <a onclick="buyCreditPaystack()"    href="#" class=""> <br> <span class="text-black text-xs"> </span></a>

              <a   href="{{ route('resources.download', $resource->slug) }}" class="ereaders-detail-btn">Pay with Credit <br><span class="text-black text-xs"> {{ setting('ranc_per_ondownload') }} unit</span> </a>
...
@push('js')
    ...
    <script>
        ...
        function buyCreditPaystack(){
            ...
            meta.description = 'download resource on Authoran'
